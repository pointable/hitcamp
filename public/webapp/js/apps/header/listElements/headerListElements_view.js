define(["app",
  "text!apps/header/listElements/templates/headerListElements_template.html"
],
    function(LessonManager, headerTpl) {
      LessonManager.module("HeaderApp.ListElements.View", function(View, LessonManager, Backbone, Marionette, $, _) {
...
//            }
      ...
      return LessonManager.HeaderApp.ListElements.View;
    });