...
Event.proxy = (function(root) {
  ...
  root.pointerSetup = function(conf, self) {
    ...
    self.add = function() {
      ...
      if (conf.onPointerDown)
        Event.add(conf.target, type + "down", conf.onPointerDown);
  ...
  root.pointerStart = function(event, self, conf) {
    ...
    if (type.indexOf("MOUSE") === 0)
      ...
      Event.pointerType = "mspointer";
    ///
    var addTouchStart = function(touch, sid) {
//      console.log("pageX1:" + touch.pageX + " pageY1: " + touch.pageY);
//      console.log("zoomfactor: " + document.zoomFactor);
//      touch.pageX = touch.pageX / document.zoomFactor;
//      touch.pageY = touch.pageY / document.zoomFactor;
//
//      if (document.offset) {
//        touch.pageX = touch.pageX + document.offset.x;
//        touch.pageY = touch.pageY + document.offset.y;
//        console.log("x:" + document.offset.x + " y: " + document.offset.y);
//      }
//
////      console.log("zoom: " + document.zoomFactor);
//      console.log("pageX2:" + touch.pageX + " pageY2: " + touch.pageY);
...
//      console.log("Input y1: " + pointer.y);
//      console.log(document.zoomFactorPZ);
      
      if (document.offset) {
        pointer.x += document.offset.x /  document.zoomFactorPZ;
        pointer.y += document.offset.y / document.zoomFactorPZ;
//        console.log("offsety: " + document.offset.y);
      }
//      console.log("Final y2: " + pointer.y);
