  ...
  if (parent.isTeacher) {
    ...
    $("#buttonSubmit").on('click', function(event) {
      ...
      if (!submitted && drawn) {
        ...
        $("#choices-area").addClass("answer-submitted");
...
//  processSetActivityResult(data);
  ...
  $("#choices-area").removeClass("answer-submitted");
  $("#choices-area").removeClass("answer-wrong");
  $("#choices-area").removeClass("answer-correct");
...
function processMarkedAnswer(data) {
  if (data.isCorrect) {
    $("#choices-area").addClass("answer-correct");
    $("#choices-area").removeClass("answer-wrong");
    $("#choices-area").removeClass("answer-submitted");
    ...
    $("#choices-area").addClass("answer-wrong");
    $("#choices-area").removeClass("answer-correct");
    $("#choices-area").removeClass("answer-submitted");
