define([
...
], function($, _, Backbone, StudentManager, pluginType, pluginCollecion) {
  ...
  StudentManager.reqres.setHandler("pluginTypes:entities", function() {
    return API.getPluginTypesEntities();
  });
  StudentManager.reqres.setHandler("pluginTypes:entities:initialized", function() {
