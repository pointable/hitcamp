define([
...
], function($, _, Backbone, StudentManager, Plugin) {
  ...
  var idSession = lessonDataFromHtml.idLesson;
  ...
  StudentManager.reqres.setHandler("plugins:entities", function() {
    return API.getPluginEntities();
  });
  StudentManager.reqres.setHandler("plugins:entities:initialized", function() {
