...
], function($, _, Backbone, StudentManager, Tiles) {
...
//      "backgroundImageJSON":""
  ...
  var idLesson = lessonDataFromHtml.idSession;

  var tileCollectionFromHtml = function() {
    var tiles = StudentManager.request("tile:entities:initialized");    
    return tiles;
  };
  ...
  StudentManager.reqres.setHandler("lesson:entity", function(id) {
    return API.getLessonEntity(id);
  });

  StudentManager.reqres.setHandler("lesson:entity:initialized", function() {
    return API.getLessonEntityInitialized();
  });

  StudentManager.reqres.setHandler("lesson:entity:new", function(id) {
    return new Lesson();
  });
