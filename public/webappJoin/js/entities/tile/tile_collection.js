...
], function($, _, Backbone, StudentManager, Tile) {
...
//            console.log(tile);
  ...
  StudentManager.reqres.setHandler("tile:entities", function() {
    return API.getTileEntities();
  });
  StudentManager.reqres.setHandler("tile:entities:initialized", function() {
