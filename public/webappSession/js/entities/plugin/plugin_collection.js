define([
...
], function($, _, Backbone, TeacherSession, Plugin) {
  ...
  TeacherSession.reqres.setHandler("plugins:entities", function() {
    return API.getPluginEntities();
  });
  TeacherSession.reqres.setHandler("plugins:entities:initialized", function() {
