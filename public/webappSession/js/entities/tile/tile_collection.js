...
], function($, _, Backbone, TeacherSession, Tile) {
...
//            console.log(tile);
  ...
  TeacherSession.reqres.setHandler("tile:entities", function() {
    return API.getTileEntities();
  });
  TeacherSession.reqres.setHandler("tile:entities:initialized", function() {
