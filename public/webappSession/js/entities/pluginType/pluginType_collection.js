define([
...
], function($, _, Backbone, TeacherSession, pluginType, pluginCollecion) {
  ...
  TeacherSession.reqres.setHandler("pluginTypes:entities", function() {
    return API.getPluginTypesEntities();
  });
  TeacherSession.reqres.setHandler("pluginTypes:entities:initialized", function() {
