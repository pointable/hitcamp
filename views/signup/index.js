...
exports.signup = function(req, res) {
  ...
  workflow.on('createAccount', function() {
    ...
    req.app.db.models.Account.create(fieldsToSet, function(err, account) {
      ...
      workflow.user.name = account.name;
...
//    require('../adventures/indexLessons').cloneWalkthrough(req, res, workflow.user._id);
    var lessonID = req.app.config.lesson.lessonIDs[0];
    require('../session/indexSession').createTestClassroom(req, res, workflow.user, lessonID);
...
//
//    if (req.session.socialProfile.emails[0].value ){
//      workflow.username = email
//    }
...
//      workflow.user.name = account.name;
  ...
  workflow.on('createClassroom', function() {
    var lessonID = req.app.config.lesson.lessonIDs[0];//require('../adventures/indexLessons').cloneWalkthrough(req, res, workflow.user._id, workflow.user.name);
    require('../session/indexSession').createTestClassroom(req, res, workflow.user, lessonID);
